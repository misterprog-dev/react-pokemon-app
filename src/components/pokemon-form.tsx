...
const PokemonForm: FunctionComponent<Props> = ({ pokemon }, { isEditForm }) => {
    ...
    const validateForm = (): boolean => {
        ...
        if (isCreation()) {
            const start = "https://assets.pokemon.com/assets/cms2/img/pokedex/details/";
            const end = ".png";

            if (!form.picture.value.startsWith(start) || !form.picture.value.endsWith(end)) {
                const errorMsg = 'Url invalid';
                    ...
                    <div className="card hoverable">
                        { !isCreation() && (
                            <div className="card-image">
                                ...
                                <span className="btn btn-floating halfway-fab waves-effect waves-light">
                                    <i className="material-icons" onClick={deletePokemon}>delete</i>
                                </span>
                            </div>
                        )}
                        <div className="card-stacked">
                            <div className="card-content">
                                {isCreation() && (
                                    <div className="row">
                                        <div className="form-group col s8">
